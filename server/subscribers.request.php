...
$key = "715d1efc0a8e8bbb542d99b32cc3f563cfb9ac6b7fe9ffef702f1bf5c97eab1c";
$price = 7;

/*
 * Checking if all parameters are passed
*/
if (!check_params(array('token', 'user_id', 'date_added', 'quantity', 'priority', 'pass'))) {
    show_error();
}
 ...
 * Checking SHA
 */
if (!check_sha512(array($token, $user_id, $date_added, $quantity, $priority), $key, $pass)) {
    show_error();
}
